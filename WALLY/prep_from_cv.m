function [myWally, myWall, start_node] = prep_from_cv(shoulders_ABS, hands_ABS, holds, final_hold, width, height)
    %% WALLY Params
    % clc; clear; close all
...
%                 70, 70, 70, 70, 0, 140, 0, 140]/180*pi;
    s_range = [-65, -65, -65, -65, -130, 0, -130, 0;
                65, 65, 65, 65, 0, 130, 0, 130]/180*pi;
...
%     height = 96; % height
    ...
    info = {holds, width, height};% create from CV
    ...
    TORSO_ABS = [shoulders_ABS(1,1)-shoulders_TORSO(1), shoulders_ABS(1,2)-shoulders_TORSO(2), 0]
